...
st.title("Export multiple CSV files into a single Excel file")
...
encoding_str = c2.selectbox("Encoding:", options=["utf-8-sig", "utf8", "latin1", "ascii", ""])
separator_str = c3.selectbox("Separator:", options=[";", ",", "\\t", "-"]).replace("\\t","\t")
